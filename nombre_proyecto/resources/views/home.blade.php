                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0">
                                            <span class="badge bg-primary-subtle border border-primary-subtle text-primary-emphasis rounded-pill mb-2">
                                                <i class="bi bi-geo-alt-fill me-1"></i>Colombia
                                            </span>
                                        </h6>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0">
                                            <span class="badge bg-primary-subtle border border-primary-subtle text-primary-emphasis rounded-pill mb-2">
                                                <i class="bi bi-calendar2-event-fill me-1"></i>11/10/2024
                                            </span>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="buy d-flex justify-content-between align-items-center">
                                    ...
                                    <h5 class="mb-0">
                                        <span class="badge text-bg-success badge-hover mb-2">Disponible</span>
                                    </h5>
                                </div>
                            </div>
                        </div>
